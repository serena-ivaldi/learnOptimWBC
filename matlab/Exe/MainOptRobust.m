...
% Parameters 
n_of_experiment = 18;      % number that we use to distinguish between the same static parameters settings but with different runtime parameters
...
configuration_file_name = 'Icub_stand_up1_free_starting_position_search'; % Icub_stand_up1_free_starting_position_search Icub_stand_up1
