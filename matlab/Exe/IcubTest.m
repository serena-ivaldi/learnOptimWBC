...
%params.qjInit      = [];
params.qjInit      = icub.InitializeState(list_of_kin_chain, params.feet_on_ground);
...
if (visualization_test)
    ...
    dim_of_task{1,1}=ones(icub.ndof,1); %dim_of_task{1,2}= [1;1;1]; dim_of_task{1,3}= ones(bot1.n,1); %dim_of_task{1,4}=ones(bot1.n,1);
