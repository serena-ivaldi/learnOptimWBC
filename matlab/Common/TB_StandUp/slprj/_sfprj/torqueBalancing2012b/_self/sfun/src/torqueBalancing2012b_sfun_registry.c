...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_torqueBalancing2012b_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_WBToolboxLibrary_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_torqueBalancing2012b_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  if (sf_WBToolboxLibrary_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_torqueBalancing2012b_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_WBToolboxLibrary_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "torqueBalancing2012b") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_torqueBalancing2012b_autoinheritance_info(nlhs,plhs,3,newRhs);
  }

  if (strcmp(machineName, "WBToolboxLibrary") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_WBToolboxLibrary_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_torqueBalancing2012b_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_WBToolboxLibrary_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "torqueBalancing2012b") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_torqueBalancing2012b_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
  ...
  if (strcmp(machineName, "WBToolboxLibrary") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_WBToolboxLibrary_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_torqueBalancing2012b_get_eml_resolved_functions_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_WBToolboxLibrary_get_eml_resolved_functions_info( int
  ...
  if (strcmp(machineName, "torqueBalancing2012b") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_torqueBalancing2012b_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
  ...
  if (strcmp(machineName, "WBToolboxLibrary") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_WBToolboxLibrary_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_torqueBalancing2012b_method_dispatcher(SimStruct *S,
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data);
extern unsigned int sf_WBToolboxLibrary_method_dispatcher(SimStruct *S, unsigned
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"torqueBalancing2012b")) {
    return(sf_torqueBalancing2012b_method_dispatcher(simstructPtr,
            chartFileNumber,specsCksum,method,data));
  }

  if (!strcmp(machineName,"WBToolboxLibrary")) {
    return(sf_WBToolboxLibrary_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void torqueBalancing2012b_terminator(void);
extern void WBToolboxLibrary_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    torqueBalancing2012b_terminator();
    WBToolboxLibrary_terminator();
...
extern void torqueBalancing2012b_initializer(void);
extern void WBToolboxLibrary_initializer(void);
extern void torqueBalancing2012b_register_exported_symbols(SimStruct* S);
extern void WBToolboxLibrary_register_exported_symbols(SimStruct* S);
extern void torqueBalancing2012b_debug_initialize(struct SfDebugInstanceStruct*);
extern void WBToolboxLibrary_debug_initialize(struct SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  torqueBalancing2012b_register_exported_symbols(S);
  WBToolboxLibrary_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      torqueBalancing2012b_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    torqueBalancing2012b_initializer();
    if (!simModeIsRTWGen) {
      WBToolboxLibrary_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    WBToolboxLibrary_initializer();
  }
