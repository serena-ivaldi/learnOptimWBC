...
static void c1_fromBaseToWorldWithImu(SFc1_torqueBalancing2012bInstanceStruct
  *chartInstance, real_T c1_imu_H_link[16], real_T c1_imu_H_link_0[16], real_T
  ...
  c1_neck[3], c1_struct_J679E6VlgqRAQnIVQBeUwF *c1_b_CONFIG, real_T c1_w_H_root
  [16]);
...
static void c1_c_emlrt_marshallIn(SFc1_torqueBalancing2012bInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  c1_struct_J679E6VlgqRAQnIVQBeUwF *c1_y);
  ...
  (SFc1_torqueBalancing2012bInstanceStruct *chartInstance)
{
  ...
  c1_struct_J679E6VlgqRAQnIVQBeUwF c1_r0;
  ...
  sf_mex_import_named("CONFIG", sf_mex_dup(c1_mxField), &c1_r0.useExtArmForces,
                      1, 11, 0U, 0, 0U, 0);
  c1_mxField = sf_mex_getfield(c1_m0, "PAUSETIME", "CONFIG", 0);
  sf_mex_import_named("CONFIG", sf_mex_dup(c1_mxField), &c1_r0.PAUSETIME, 1, 0,
                      0U, 0, 0U, 0);
  ...
  *chartInstance)
{
  ...
  int32_T c1_i14;
  real_T c1_neck[3];
  c1_struct_J679E6VlgqRAQnIVQBeUwF c1_b_CONFIG;
  ...
  int32_T c1_i20;
  real_T c1_b_neck[3];
  c1_struct_J679E6VlgqRAQnIVQBeUwF c1_c_CONFIG;
  real_T c1_dv1[16];
  int32_T c1_i21;
  int32_T c1_i22;
  ...
  *c1_inData)
{
  ...
  c1_struct_J679E6VlgqRAQnIVQBeUwF c1_u;
  const mxArray *c1_y = NULL;
  real_T c1_b_u;
  const mxArray *c1_b_y = NULL;
  ...
  c1_mxArrayOutData = NULL;
  c1_mxArrayOutData = NULL;
  c1_u = *(c1_struct_J679E6VlgqRAQnIVQBeUwF *)c1_inData;
  c1_y = NULL;
  ...
  c1_db_u = c1_u.PAUSETIME;
  c1_db_y = NULL;
  sf_mex_assign(&c1_db_y, sf_mex_create("y", &c1_db_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_addfield(c1_y, c1_db_y, "PAUSETIME", "PAUSETIME", 0);
  sf_mex_assign(&c1_mxArrayOutData, c1_y, FALSE);
  return c1_mxArrayOutData;
}
  ...
  c1_struct_J679E6VlgqRAQnIVQBeUwF *c1_y)
{
  ...
  c1_thisId.fIdentifier = "PAUSETIME";
  c1_y->PAUSETIME = c1_d_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getfield(c1_u, "PAUSETIME", "PAUSETIME", 0)), &c1_thisId);
  sf_mex_destroy(&c1_u);
}
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  *(c1_struct_J679E6VlgqRAQnIVQBeUwF *)c1_outData = c1_y;
  sf_mex_destroy(&c1_mxArrayInData);
}
