...
static void c2_fromBaseToWorldWithImu(SFc2_torqueBalancing2012bInstanceStruct
  *chartInstance, real_T c2_imu_H_link[16], real_T c2_imu_H_link_0[16], real_T
  ...
  c2_neck[3], c2_struct_fR15Ssc1WQXbOnIMnL7PtC *c2_b_CONFIG, real_T c2_w_H_root
  [16]);
...
static void c2_c_emlrt_marshallIn(SFc2_torqueBalancing2012bInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  c2_struct_fR15Ssc1WQXbOnIMnL7PtC *c2_y);
  ...
  (SFc2_torqueBalancing2012bInstanceStruct *chartInstance)
{
  ...
  c2_struct_fR15Ssc1WQXbOnIMnL7PtC c2_r0;
  ...
  *chartInstance)
{
  ...
  int32_T c2_i14;
  real_T c2_neck[3];
  c2_struct_fR15Ssc1WQXbOnIMnL7PtC c2_b_CONFIG;
  ...
  int32_T c2_i20;
  real_T c2_b_neck[3];
  c2_struct_fR15Ssc1WQXbOnIMnL7PtC c2_c_CONFIG;
  real_T c2_dv1[16];
  int32_T c2_i21;
  int32_T c2_i22;
  ...
  *c2_inData)
{
  ...
  c2_struct_fR15Ssc1WQXbOnIMnL7PtC c2_u;
  const mxArray *c2_y = NULL;
  real_T c2_b_u;
  const mxArray *c2_b_y = NULL;
  ...
  c2_mxArrayOutData = NULL;
  c2_mxArrayOutData = NULL;
  c2_u = *(c2_struct_fR15Ssc1WQXbOnIMnL7PtC *)c2_inData;
  c2_y = NULL;
  ...
  for (c2_i228 = 0; c2_i228 < 23; c2_i228++) {
    c2_y_u[c2_i228] = c2_u.JOINTSITING[c2_i228];
  }

  c2_y_y = NULL;
  sf_mex_assign(&c2_y_y, sf_mex_create("y", c2_y_u, 0, 0U, 1U, 0U, 2, 23, 1),
                FALSE);
  sf_mex_addfield(c2_y, c2_y_y, "JOINTSITING", "JOINTSITING", 0);
  for (c2_i229 = 0; c2_i229 < 23; c2_i229++) {
    c2_ab_u[c2_i229] = c2_u.JOINTS[c2_i229];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  *(c2_struct_fR15Ssc1WQXbOnIMnL7PtC *)c2_outData = c2_y;
  sf_mex_destroy(&c2_mxArrayInData);
}
