...
static void c2_fromBaseToWorldWithImu(SFc2_torqueBalancing2012bInstanceStruct
  *chartInstance, real_T c2_imu_H_link[16], real_T c2_imu_H_link_0[16], real_T
  ...
  c2_neck[3], c2_struct_6drkWFoHJIWwAUE1rJmWJH *c2_b_CONFIG, real_T c2_w_H_root
  [16]);
...
static void c2_c_emlrt_marshallIn(SFc2_torqueBalancing2012bInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  c2_struct_6drkWFoHJIWwAUE1rJmWJH *c2_y);
  ...
  (SFc2_torqueBalancing2012bInstanceStruct *chartInstance)
{
  ...
  c2_struct_6drkWFoHJIWwAUE1rJmWJH c2_r0;
  ...
  sf_mex_import_named("CONFIG", sf_mex_dup(c2_mxField), c2_r0.JOINTSITING, 1, 0,
                      0U, 1, 0U, 2, 23, 1);
  c2_mxField = sf_mex_getfield(c2_m0, "FIXEDCOMBENCH", "CONFIG", 0);
  sf_mex_import_named("CONFIG", sf_mex_dup(c2_mxField), &c2_r0.FIXEDCOMBENCH, 1,
                      11, 0U, 0, 0U, 0);
  ...
  *chartInstance)
{
  ...
  int32_T c2_i14;
  real_T c2_neck[3];
  c2_struct_6drkWFoHJIWwAUE1rJmWJH c2_b_CONFIG;
  ...
  int32_T c2_i20;
  real_T c2_b_neck[3];
  c2_struct_6drkWFoHJIWwAUE1rJmWJH c2_c_CONFIG;
  real_T c2_dv1[16];
  int32_T c2_i21;
  int32_T c2_i22;
  ...
  *c2_inData)
{
  ...
  c2_struct_6drkWFoHJIWwAUE1rJmWJH c2_u;
  const mxArray *c2_y = NULL;
  real_T c2_b_u;
  const mxArray *c2_b_y = NULL;
  ...
  c2_mxArrayOutData = NULL;
  c2_mxArrayOutData = NULL;
  c2_u = *(c2_struct_6drkWFoHJIWwAUE1rJmWJH *)c2_inData;
  c2_y = NULL;
  ...
  c2_bb_u = c2_u.FIXEDCOMBENCH;
  c2_bb_y = NULL;
  sf_mex_assign(&c2_bb_y, sf_mex_create("y", &c2_bb_u, 11, 0U, 0U, 0U, 0), FALSE);
  sf_mex_addfield(c2_y, c2_bb_y, "FIXEDCOMBENCH", "FIXEDCOMBENCH", 0);
  c2_cb_u = c2_u.iCubStandUp;
  c2_cb_y = NULL;
  sf_mex_assign(&c2_cb_y, sf_mex_create("y", &c2_cb_u, 11, 0U, 0U, 0U, 0), FALSE);
  sf_mex_addfield(c2_y, c2_cb_y, "iCubStandUp", "iCubStandUp", 0);
  c2_db_u = c2_u.useExtArmForces;
  c2_db_y = NULL;
  sf_mex_assign(&c2_db_y, sf_mex_create("y", &c2_db_u, 11, 0U, 0U, 0U, 0), FALSE);
  sf_mex_addfield(c2_y, c2_db_y, "useExtArmForces", "useExtArmForces", 0);
  sf_mex_assign(&c2_mxArrayOutData, c2_y, FALSE);
  return c2_mxArrayOutData;
}
...
{
  emlrtMsgIdentifier c2_thisId;
  static const char * c2_fieldNames[22] = { "SIMULATION_TIME", "SCOPES",
  ...
  sf_mex_check_struct(c2_parentId, c2_u, 22, c2_fieldNames, 0U, 0);
  ...
  c2_thisId.fIdentifier = "FIXEDCOMBENCH";
  c2_y->FIXEDCOMBENCH = c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getfield(c2_u, "FIXEDCOMBENCH", "FIXEDCOMBENCH", 0)), &c2_thisId);
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  *(c2_struct_6drkWFoHJIWwAUE1rJmWJH *)c2_outData = c2_y;
  sf_mex_destroy(&c2_mxArrayInData);
}
