...
static void c40_fromBaseToWorldWithImu(SFc40_torqueBalancing2012bInstanceStruct *
  ...
  real_T c40_neck[3], c40_struct_fR15Ssc1WQXbOnIMnL7PtC *c40_b_CONFIG, real_T
  c40_w_H_root[16]);
...
static void c40_c_emlrt_marshallIn(SFc40_torqueBalancing2012bInstanceStruct
  *chartInstance, const mxArray *c40_u, const emlrtMsgIdentifier *c40_parentId,
  c40_struct_fR15Ssc1WQXbOnIMnL7PtC *c40_y);
  ...
  (SFc40_torqueBalancing2012bInstanceStruct *chartInstance)
{
  ...
  c40_struct_fR15Ssc1WQXbOnIMnL7PtC c40_r0;
  ...
  *chartInstance)
{
  ...
  int32_T c40_i14;
  real_T c40_neck[3];
  c40_struct_fR15Ssc1WQXbOnIMnL7PtC c40_b_CONFIG;
  ...
  int32_T c40_i20;
  real_T c40_b_neck[3];
  c40_struct_fR15Ssc1WQXbOnIMnL7PtC c40_c_CONFIG;
  real_T c40_dv1[16];
  int32_T c40_i21;
  int32_T c40_i22;
  ...
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 31U, chartInstance->c40_sfEvent);
  ...
  chartInstance->c40_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 31U, chartInstance->c40_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 31U, chartInstance->c40_sfEvent);
  ...
  *c40_inData)
{
  ...
  c40_struct_fR15Ssc1WQXbOnIMnL7PtC c40_u;
  const mxArray *c40_y = NULL;
  real_T c40_b_u;
  const mxArray *c40_b_y = NULL;
  ...
  c40_mxArrayOutData = NULL;
  c40_mxArrayOutData = NULL;
  c40_u = *(c40_struct_fR15Ssc1WQXbOnIMnL7PtC *)c40_inData;
  c40_y = NULL;
  ...
  for (c40_i228 = 0; c40_i228 < 23; c40_i228++) {
    c40_y_u[c40_i228] = c40_u.JOINTSITING[c40_i228];
  }

  c40_y_y = NULL;
  sf_mex_assign(&c40_y_y, sf_mex_create("y", c40_y_u, 0, 0U, 1U, 0U, 2, 23, 1),
                FALSE);
  sf_mex_addfield(c40_y, c40_y_y, "JOINTSITING", "JOINTSITING", 0);
  for (c40_i229 = 0; c40_i229 < 23; c40_i229++) {
    c40_ab_u[c40_i229] = c40_u.JOINTS[c40_i229];
  }
  ...
  *c40_mxArrayInData, const char_T *c40_varName, void *c40_outData)
{
  ...
  *(c40_struct_fR15Ssc1WQXbOnIMnL7PtC *)c40_outData = c40_y;
  sf_mex_destroy(&c40_mxArrayInData);
}
