...
static void c36_fromBaseToWorldWithImu(SFc36_torqueBalancing2012bInstanceStruct *
  ...
  real_T c36_neck[3], c36_struct_szunj786Fa70tQRn01KlgE *c36_b_CONFIG, real_T
  c36_w_H_root[16]);
...
static void c36_c_emlrt_marshallIn(SFc36_torqueBalancing2012bInstanceStruct
  *chartInstance, const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId,
  c36_struct_szunj786Fa70tQRn01KlgE *c36_y);
  ...
  (SFc36_torqueBalancing2012bInstanceStruct *chartInstance)
{
  ...
  c36_struct_szunj786Fa70tQRn01KlgE c36_r0;
  ...
  sf_mex_import_named("CONFIG", sf_mex_dup(c36_mxField), &c36_r0.DEMO_MOVEMENTS,
                      1, 11, 0U, 0, 0U, 0);
  c36_mxField = sf_mex_getfield(c36_m0, "PARAM", "CONFIG", 0);
  sf_mex_import_named("CONFIG", sf_mex_dup(c36_mxField), &c36_r0.PARAM, 1, 0, 0U,
                      0, 0U, 0);
  ...
  *chartInstance)
{
  ...
  int32_T c36_i14;
  real_T c36_neck[3];
  c36_struct_szunj786Fa70tQRn01KlgE c36_b_CONFIG;
  ...
  int32_T c36_i20;
  real_T c36_b_neck[3];
  c36_struct_szunj786Fa70tQRn01KlgE c36_c_CONFIG;
  real_T c36_dv1[16];
  int32_T c36_i21;
  int32_T c36_i22;
  ...
  *c36_inData)
{
  ...
  c36_struct_szunj786Fa70tQRn01KlgE c36_u;
  const mxArray *c36_y = NULL;
  real_T c36_b_u;
  const mxArray *c36_b_y = NULL;
  ...
  c36_mxArrayOutData = NULL;
  c36_mxArrayOutData = NULL;
  c36_u = *(c36_struct_szunj786Fa70tQRn01KlgE *)c36_inData;
  c36_y = NULL;
  ...
  sf_mex_addfield(c36_y, c36_x_y, "PARAM", "PARAM", 0);
  c36_y_u = c36_u.TIME_CONTROLLER_SWITCH;
  c36_y_y = NULL;
  sf_mex_assign(&c36_y_y, sf_mex_create("y", &c36_y_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_addfield(c36_y, c36_y_y, "TIME_CONTROLLER_SWITCH",
                  "TIME_CONTROLLER_SWITCH", 0);
  for (c36_i228 = 0; c36_i228 < 23; c36_i228++) {
    c36_ab_u[c36_i228] = c36_u.JOINTS[c36_i228];
  }

  c36_ab_y = NULL;
  sf_mex_assign(&c36_ab_y, sf_mex_create("y", c36_ab_u, 0, 0U, 1U, 0U, 2, 23, 1),
                FALSE);
  sf_mex_addfield(c36_y, c36_ab_y, "JOINTS", "JOINTS", 0);
  ...
  c36_struct_szunj786Fa70tQRn01KlgE *c36_y)
{
  ...
  c36_thisId.fIdentifier = "PARAM";
  c36_y->PARAM = c36_d_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getfield(c36_u, "PARAM", "PARAM", 0)), &c36_thisId);
  ...
  real_T c36_y[2])
{
  ...
  sf_mex_import(c36_parentId, sf_mex_dup(c36_u), c36_dv23, 1, 0, 0U, 1, 0U, 2, 1,
                2);
  for (c36_i229 = 0; c36_i229 < 2; c36_i229++) {
    c36_y[c36_i229] = c36_dv23[c36_i229];
  }
  ...
  real_T c36_y[23])
{
  ...
  sf_mex_import(c36_parentId, sf_mex_dup(c36_u), c36_dv24, 1, 0, 0U, 1, 0U, 2,
                23, 1);
  for (c36_i230 = 0; c36_i230 < 23; c36_i230++) {
    c36_y[c36_i230] = c36_dv24[c36_i230];
  }
  ...
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData)
{
  ...
  *(c36_struct_szunj786Fa70tQRn01KlgE *)c36_outData = c36_y;
  sf_mex_destroy(&c36_mxArrayInData);
}
  ...
  *c36_inData)
{
  ...
  chartInstance = (SFc36_torqueBalancing2012bInstanceStruct *)chartInstanceVoid;
  c36_mxArrayOutData = NULL;
  for (c36_i231 = 0; c36_i231 < 3; c36_i231++) {
    c36_b_inData[c36_i231] = (*(real_T (*)[3])c36_inData)[c36_i231];
  }

  for (c36_i232 = 0; c36_i232 < 3; c36_i232++) {
    c36_u[c36_i232] = c36_b_inData[c36_i232];
  }
  ...
  *c36_inData)
{
  ...
  chartInstance = (SFc36_torqueBalancing2012bInstanceStruct *)chartInstanceVoid;
  c36_mxArrayOutData = NULL;
  for (c36_i233 = 0; c36_i233 < 12; c36_i233++) {
    c36_b_inData[c36_i233] = (*(real_T (*)[12])c36_inData)[c36_i233];
  }

  for (c36_i234 = 0; c36_i234 < 12; c36_i234++) {
    c36_u[c36_i234] = c36_b_inData[c36_i234];
  }
  ...
  *c36_inData)
{
  ...
  c36_mxArrayOutData = NULL;
  c36_i235 = 0;
  for (c36_i236 = 0; c36_i236 < 3; c36_i236++) {
    for (c36_i237 = 0; c36_i237 < 3; c36_i237++) {
      c36_b_inData[c36_i237 + c36_i235] = (*(real_T (*)[9])c36_inData)[c36_i237
        + c36_i235];
    }
  ...
  c36_i238 = 0;
  for (c36_i239 = 0; c36_i239 < 3; c36_i239++) {
    for (c36_i240 = 0; c36_i240 < 3; c36_i240++) {
      c36_u[c36_i240 + c36_i238] = c36_b_inData[c36_i240 + c36_i238];
    }
  ...
  real_T c36_y[9])
{
  ...
  sf_mex_import(c36_parentId, sf_mex_dup(c36_u), c36_dv25, 1, 0, 0U, 1, 0U, 2, 3,
                3);
  for (c36_i241 = 0; c36_i241 < 9; c36_i241++) {
    c36_y[c36_i241] = c36_dv25[c36_i241];
  }
  ...
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData)
{
  ...
  c36_i242 = 0;
  for (c36_i243 = 0; c36_i243 < 3; c36_i243++) {
    for (c36_i244 = 0; c36_i244 < 3; c36_i244++) {
      (*(real_T (*)[9])c36_outData)[c36_i244 + c36_i242] = c36_y[c36_i244 +
        c36_i242];
    }
  ...
  real_T c36_y[3])
{
  ...
  for (c36_i245 = 0; c36_i245 < 3; c36_i245++) {
    c36_y[c36_i245] = c36_dv26[c36_i245];
  }
  ...
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData)
{
  ...
  for (c36_i246 = 0; c36_i246 < 3; c36_i246++) {
    (*(real_T (*)[3])c36_outData)[c36_i246] = c36_y[c36_i246];
  }
  ...
  real_T c36_y[12])
{
  ...
  sf_mex_import(c36_parentId, sf_mex_dup(c36_u), c36_dv27, 1, 0, 0U, 1, 0U, 1,
                12);
  for (c36_i247 = 0; c36_i247 < 12; c36_i247++) {
    c36_y[c36_i247] = c36_dv27[c36_i247];
  }
  ...
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData)
{
  ...
  for (c36_i248 = 0; c36_i248 < 12; c36_i248++) {
    (*(real_T (*)[12])c36_outData)[c36_i248] = c36_y[c36_i248];
  }
...
const mxArray *sf_c36_torqueBalancing2012b_get_eml_resolved_functions_info(void)
{
  ...
  for (c36_i249 = 0; c36_i249 < 147; c36_i249++) {
    c36_r1 = &c36_info[c36_i249];
...
static void c36_info_helper(c36_ResolvedFunctionInfo c36_info[147])
{
  ...
  c36_info[0].fileTimeLo = 1495096798U;
  ...
  c36_info[6].fileTimeLo = 1495096797U;
  ...
  c36_info[11].fileTimeLo = 1495096798U;
  ...
  c36_info[22].fileTimeLo = 1495096798U;
  ...
  c36_info[25].fileTimeLo = 1495096797U;
  ...
  c36_info[33].fileTimeLo = 1495096797U;
  ...
  c36_info[36].fileTimeLo = 1495096798U;
  ...
  *chartInstance)
{
  ...
  char_T c36_b_u[4];
  const mxArray *c36_b_y = NULL;
  for (c36_i250 = 0; c36_i250 < 30; c36_i250++) {
    c36_u[c36_i250] = c36_cv0[c36_i250];
  }

  c36_y = NULL;
  sf_mex_assign(&c36_y, sf_mex_create("y", c36_u, 10, 0U, 1U, 0U, 2, 1, 30),
                FALSE);
  for (c36_i251 = 0; c36_i251 < 4; c36_i251++) {
    c36_b_u[c36_i251] = c36_cv1[c36_i251];
  }
...
{
  int32_T c36_i252;
  for (c36_i252 = 0; c36_i252 < 16; c36_i252++) {
    c36_b_A[c36_i252] = c36_A[c36_i252];
  }
   ...
   c36_overflow)
{
  ...
  if (!c36_overflow) {
    ...
    for (c36_i253 = 0; c36_i253 < 34; c36_i253++) {
      c36_u[c36_i253] = c36_cv2[c36_i253];
    }

    c36_y = NULL;
    sf_mex_assign(&c36_y, sf_mex_create("y", c36_u, 10, 0U, 1U, 0U, 2, 1, 34),
                  FALSE);
    for (c36_i254 = 0; c36_i254 < 23; c36_i254++) {
      c36_b_u[c36_i254] = c36_cv3[c36_i254];
    }
...
{
  int32_T c36_i255;
  for (c36_i255 = 0; c36_i255 < 16; c36_i255++) {
    c36_b_A[c36_i255] = c36_A[c36_i255];
  }
  ...
  *chartInstance, real_T c36_A[16], real_T c36_B[16], real_T c36_b_B[16])
{
  ...
  for (c36_i256 = 0; c36_i256 < 16; c36_i256++) {
    c36_b_B[c36_i256] = c36_B[c36_i256];
  }

  for (c36_i257 = 0; c36_i257 < 16; c36_i257++) {
    c36_b_A[c36_i257] = c36_A[c36_i257];
  }
  ...
  *chartInstance, real_T c36_A[16], real_T c36_B[16], real_T c36_b_B[16])
{
  ...
  for (c36_i258 = 0; c36_i258 < 16; c36_i258++) {
    c36_b_B[c36_i258] = c36_B[c36_i258];
  }

  for (c36_i259 = 0; c36_i259 < 16; c36_i259++) {
    c36_b_A[c36_i259] = c36_A[c36_i259];
  }
  ...
  *chartInstance)
{
  ...
  char_T c36_u[27];
  const mxArray *c36_y = NULL;
  for (c36_i260 = 0; c36_i260 < 27; c36_i260++) {
    c36_u[c36_i260] = c36_varargin_1[c36_i260];
  }
  ...
  *chartInstance, const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId)
{
  int32_T c36_y;
  int32_T c36_i261;
  sf_mex_import(c36_parentId, sf_mex_dup(c36_u), &c36_i261, 1, 6, 0U, 0, 0U, 0);
  c36_y = c36_i261;
  sf_mex_destroy(&c36_u);
  return c36_y;
}
  ...
  *chartInstance, real_T c36_A[16], int32_T c36_ipiv[4], int32_T *c36_info)
{
  ...
  for (c36_i262 = 0; c36_i262 < 4; c36_i262++) {
    c36_ipiv[c36_i262] = 1 + c36_i262;
  }
  ...
  *c36_info = 0;
  for (c36_j = 1; c36_j < 4; c36_j++) {
    ...
    if (c36_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      ...
      for (c36_i = c36_b_jp1j; c36_i <= c36_i263; c36_i++) {
        c36_b_i = c36_i;
  ...
  if (c36_d_alpha1 == 0.0) {
    ...
    for (c36_j = 1; c36_j <= c36_e_n; c36_j++) {
      ...
      if (c36_yjy != 0.0) {
        ...
        for (c36_ijA = c36_i264; c36_ijA <= c36_i265; c36_ijA++) {
          c36_b_ijA = c36_ijA;
          c36_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
  ...
  for (c36_j = 1; c36_j < 5; c36_j++) {
    ...
    for (c36_k = 1; c36_k < 5; c36_k++) {
      ...
      if (c36_B[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
        ...
        for (c36_i = c36_i266 + 1; c36_i < 5; c36_i++) {
          c36_b_i = c36_i;
          c36_e_a = c36_b_i;
          c36_f_b = c36_jBcol;
  ...
  for (c36_j = 1; c36_j < 5; c36_j++) {
    ...
    for (c36_k = 4; c36_k > 0; c36_k--) {
      ...
      if (c36_B[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
        ...
        for (c36_i = 1; c36_i <= c36_i267; c36_i++) {
          c36_b_i = c36_i;
          c36_h_a = c36_b_i;
          c36_k_b = c36_jBcol;
