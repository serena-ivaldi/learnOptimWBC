...
CONFIG.TIME_CONTROLLER_SWITCH = 10;        
...
%CONFIG.JOINTSITING = params.qfinalSitting; 
 ...
 %CONFIG.JOINTS      = [  13   0  0   -20.0  30.0  0.0  45.0  -20.0  30.0  0.0  45.0   90 0  0 -100 -10.4 0   90 0  0 -100 -10.4 0]'*(pi/180);
 %CONFIG.JOINTSITING = [  13   0  0   -20.0  30.0  0.0  45.0  -20.0  30.0  0.0  45.0   90 0  0 -100 -10.4 0   90 0  0 -100 -10.4 0]'*(pi/180);
    


CONFIG.JOINTSITING      = [50.1857703540998,-0.533038872192590,1.44785345374291,...
                           -27.3037636133022,39.9416098290793,4.54148870460762,43.1813130427136,...
                           -27.3040461636777,39.9411577140989,4.54152590534171,43.1814084163514,...
                           61.4480168234164,0.297235353538209,-0.145951076001808,-99.1571404298116,-15.6142439364711,0.0610744452794047,...
                           61.4791751123232,0.237790666608333,-0.0564860341198656,-99.0849810833032,-15.5651024227906,0.0556713433800658]'*(pi/180);
 CONFIG.JOINTS     =[70.0000001093867 0.618804962651733 0.399999267875981...
