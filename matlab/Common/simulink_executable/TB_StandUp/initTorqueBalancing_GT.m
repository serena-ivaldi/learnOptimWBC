...
run(strcat('app/robots/',getenv('YARP_ROBOT_NAME'),'/gains_GT.m')); 
addpath('./src/')
addpath('./utilityMatlabFunctions/')

robotSpecificReferences = fullfile('app/robots',getenv('YARP_ROBOT_NAME'),'initRefGen_GT.m');
