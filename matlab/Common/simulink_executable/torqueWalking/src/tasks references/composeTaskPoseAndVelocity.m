...
%% --- Initialization ---
function [pos_vel_CoM, pose_vel_LFoot, pose_vel_RFoot, orient_vel_rot_task, pose_vel_LHand, pose_vel_RHand] = ...
             composeTaskPoseAndVelocity(vel_CoM, vel_LFoot, vel_RFoot, vel_rot_task, vel_LHand, vel_RHand, ...
                                        w_H_CoM, w_H_l_sole, w_H_r_sole, w_H_rot_task, w_H_l_hand, w_H_r_hand)
    ...
    % compose LHand pose and velocity
    pose_vel_LHand  = [w_H_l_hand(1:3,4),   vel_LHand(1:3), zeros(3,2);
                       w_H_l_hand(1:3,1:3), vel_LHand(4:6)];
                  
    % compose RHand pose and velocity
    pose_vel_RHand  = [w_H_r_hand(1:3,4),   vel_RHand(1:3), zeros(3,2);
                       w_H_r_hand(1:3,1:3), vel_RHand(4:6)];
end