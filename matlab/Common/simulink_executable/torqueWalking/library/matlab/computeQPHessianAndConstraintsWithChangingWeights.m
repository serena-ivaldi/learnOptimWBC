...
function [Hessian, gradient, ConstraintMatrix, biasVectorConstraint] = ...
             computeQPHessianAndConstraints(s, nu, s_sDot_sDDot_ref, impedances, dampings, J, JDot_nu, acc_task_star, feetInContact, Weights, Sat, Config)
     ...
     if Config.QP_USE_STRICT_TASK_PRIORITIES 
         ...
         sum_task_weights = Weights.weightPostural + Weights.weightCoM  + Weights.weightRotTask + weightLeftFoot + weightRightFoot ...
             + Weights.weightLeftHand + Weights.weightRightHand;
         
         % compute Hessian matrix
         Hessian = eye(size(s,1) +6) * sum_task_weights;
         
         % compute gradient
         gradient =  Weights.weightPostural  * [k*nu(1:6); -sDDot_star] ...
                   ...
                   + Weights.weightCoM       * pinv(J(13:15, :), Sat.pinvDamp_nu_b) * (JDot_nu(13:15) - acc_task_star(13:15)) ...
                   + Weights.weightRotTask   * pinv(J(16:18, :), Sat.pinvDamp_nu_b) * (JDot_nu(16:18) - acc_task_star(16:18)) ...
                   + Weights.weightLeftHand  * pinv(J(19:24, :), Sat.pinvDamp_nu_b) * (JDot_nu(19:24) - acc_task_star(19:24)) ...
                   + Weights.weightRightHand * pinv(J(25:30, :), Sat.pinvDamp_nu_b) * (JDot_nu(25:30) - acc_task_star(25:30));        
