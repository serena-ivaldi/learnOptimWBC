function fit  = fitness_iCub_newlimits(obj,output) 
% fitness function of the two arms experience on the iCub with more collision checks : reaching two
...
% joints limits, torques limits and colision detection as constraints.
    ...
    for i=1:downsaple:size(t,1)
        ...
        p8 = (p1+p2)./2;
        p9 = (p5+p6)./2;
        control_points = [ee_r'; p1'; p2'; p3'; p4'; ee_l'; p5'; p6'; p7'; p8'; p9'];
        ...
        input_vector = {q_cur(8),q_cur(8),q_cur(9),q_cur(9),q_cur(10),q_cur(10),q_cur(11),q_cur(11),q_cur(12),q_cur(12),q_cur(13),q_cur(13),q_cur(14),q_cur(14),...
                        ...
                        control_points(6,:),control_points(7,:),control_points(8,:),control_points(9,:),control_points(10,:),control_points(11,:)};            
