function fit  = fitnessHumanoids2(obj,output) 
    ...
    for i=1:downsaple:size(t,2)
        ...
        input_vector = {q_cur(1),q_cur(1),q_cur(2),q_cur(2),q_cur(3),q_cur(3),q_cur(4),q_cur(4),q_cur(5),q_cur(5),q_cur(6),q_cur(6),q_cur(7),q_cur(7),...
                        qd_cur(1),qd_cur(1),qd_cur(2),qd_cur(2),qd_cur(3),qd_cur(3),qd_cur(4),qd_cur(4),qd_cur(5),qd_cur(5),qd_cur(6),qd_cur(6),qd_cur(7),qd_cur(7),...
