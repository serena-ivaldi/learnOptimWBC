...
geom_parameters{1,1} =  [7, 5 ,     2 ,      -0.120249695321353,-0.0680999719842103,0.369603821651986, 0.0167667444901888,-0.0681008604452745,0.503988037442802];
...
switch CONTROLLERTYPE
    case 'BalanceController'
        ...
        cmaes_value_range{1} = [ 0, 0, 0, 0, 0,0,0 -0.12,-0.12,-0.12,-0.12,-0.12,  0.36,0.36,0.36,0.36,0.36 ];  % lower bound that define the search space
        cmaes_value_range{2} = [ 1, 1, 1, 1, 1,1,1  0.016,0.016,0.016,0.016,0.016, 0.50,0.50,0.50,0.50,0.50];  % upper bound that define the search space
