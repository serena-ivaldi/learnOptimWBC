/*! \file Puma560_inertia_row_2.h
\brief Computation of the robot specific inertia matrix row for corresponding to joint 2 of 6. 
    
  
Given a full set of joint variables this function computes the 
inertia matrix row number 2 of 6 for Puma 560 copy. Angles have to be given in radians! 
...
/*!\fn void Puma560_inertia_row_2(double I_row_2[][1], const double* input1);
\param input1:  6-element vector of generalized coordinates.
\param I_row_2:  [1x6] output row of the robot inertia matrix.
*/


#ifndef PUMA560_INERTIA_ROW_2_H
#define PUMA560_INERTIA_ROW_2_H

#include "math.h"

void Puma560_inertia_row_2(double I_row_2[][1], const double* input1);

#endif /*PUMA560_INERTIA_ROW_2_H */
