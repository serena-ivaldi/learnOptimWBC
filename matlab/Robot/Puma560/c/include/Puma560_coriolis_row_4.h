/*! \file Puma560_coriolis_row_4.h
\brief Computation of the robot specific Coriolis matrix row for corresponding to joint 4 of 6. 
    
  
Given a full set of joint variables this function computes the 
Coriolis matrix row number 4 of 6 for Puma 560 copy. Angles have to be given in radians! 
...
/*!\fn void Puma560_coriolis_row_4(double C_row_4[][1], const double* input1, const double* input2);
\param input1:  6-element vector of generalized coordinates
\param input2: 6-element vector of generalized velocities
\param C_row_4:  [1x6] row of the robot Coriolis matrix
*/


#ifndef PUMA560_CORIOLIS_ROW_4_H
#define PUMA560_CORIOLIS_ROW_4_H

#include "math.h"

void Puma560_coriolis_row_4(double C_row_4[][1], const double* input1, const double* input2);

#endif /*PUMA560_CORIOLIS_ROW_4_H */
