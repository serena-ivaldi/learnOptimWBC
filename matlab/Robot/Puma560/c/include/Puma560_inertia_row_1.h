/*! \file Puma560_inertia_row_1.h
\brief Computation of the robot specific inertia matrix row for corresponding to joint 1 of 6. 
    
  
Given a full set of joint variables this function computes the 
inertia matrix row number 1 of 6 for Puma 560 copy. Angles have to be given in radians! 
...
/*!\fn void Puma560_inertia_row_1(double I_row_1[][1], const double* input1);
\param input1:  6-element vector of generalized coordinates.
\param I_row_1:  [1x6] output row of the robot inertia matrix.
*/


#ifndef PUMA560_INERTIA_ROW_1_H
#define PUMA560_INERTIA_ROW_1_H

#include "math.h"

void Puma560_inertia_row_1(double I_row_1[][1], const double* input1);

#endif /*PUMA560_INERTIA_ROW_1_H */
