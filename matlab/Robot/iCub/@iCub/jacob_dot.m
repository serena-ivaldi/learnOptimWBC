function jacob_dot = jacob_dot(rob,q,dq)
...
jacob_dot = wholeBodyModel('djdq',rob.R_b,rob.x_b,q,dq,[rob.dx_b;rob.omega_w],rob.kinematic_chain_selector(rob.cur_chain)); 
