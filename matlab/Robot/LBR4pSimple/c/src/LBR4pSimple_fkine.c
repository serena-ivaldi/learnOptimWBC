#include "LBR4pSimple_fkine.h"

void LBR4pSimple_fkine(double T[][4], const double* input1){
 ...
 T[3][3]=0;
  ...
  T[3][0] = cos(q1)*sin(q2)*(2.0/5.0)-cos(q6)*(sin(q4)*(sin(q1)*sin(q3)-cos(q1)*cos(q2)*cos(q3))-cos(q1)*cos(q4)*sin(q2))*1.518E-1-sin(q6)*(cos(q5)*(cos(q4)*(sin(q1)*sin(q3)-cos(q1)*cos(q2)*cos(q3))+cos(q1)*sin(q2)*sin(q4))+sin(q5)*(cos(q3)*sin(q1)+cos(q1)*cos(q2)*sin(q3)))*1.518E-1-sin(q4)*(sin(q1)*sin(q3)-cos(q1)*cos(q2)*cos(q3))*(3.9E1/1.0E2)+cos(q1)*cos(q4)*sin(q2)*(3.9E1/1.0E2);
  T[3][1] = sin(q1)*sin(q2)*(2.0/5.0)+cos(q6)*(sin(q4)*(cos(q1)*sin(q3)+cos(q2)*cos(q3)*sin(q1))+cos(q4)*sin(q1)*sin(q2))*1.518E-1+sin(q6)*(cos(q5)*(cos(q4)*(cos(q1)*sin(q3)+cos(q2)*cos(q3)*sin(q1))-sin(q1)*sin(q2)*sin(q4))+sin(q5)*(cos(q1)*cos(q3)-cos(q2)*sin(q1)*sin(q3)))*1.518E-1+sin(q4)*(cos(q1)*sin(q3)+cos(q2)*cos(q3)*sin(q1))*(3.9E1/1.0E2)+cos(q4)*sin(q1)*sin(q2)*(3.9E1/1.0E2);
  T[3][2] = cos(q2)*(2.0/5.0)+cos(q2)*cos(q4)*(3.9E1/1.0E2)-sin(q6)*(cos(q5)*(cos(q2)*sin(q4)+cos(q3)*cos(q4)*sin(q2))-sin(q2)*sin(q3)*sin(q5))*1.518E-1+cos(q6)*(cos(q2)*cos(q4)-cos(q3)*sin(q2)*sin(q4))*1.518E-1-cos(q3)*sin(q2)*sin(q4)*(3.9E1/1.0E2)+3.1E1/1.0E2;
  T[3][3] = 1.0;
}
