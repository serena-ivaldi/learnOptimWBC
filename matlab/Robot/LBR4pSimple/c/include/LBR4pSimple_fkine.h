/*! \file fkine.h
\brief C version of the forward kinematics solution including tool transformation for the LBR4pSimple copy arm. 
...
/*!\fn void LBR4pSimple_fkine(double T[][4], const double* input1);
...
#ifndef LBR4PSIMPLE_FKINE_H
#define LBR4PSIMPLE_FKINE_H

#include "math.h"

void LBR4pSimple_fkine(double T[][4], const double* input1);

#endif /*LBR4PSIMPLE_FKINE_H */
