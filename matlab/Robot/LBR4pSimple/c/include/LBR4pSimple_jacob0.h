/*! \file LBR4pSimple_jacob0.h
\brief C code for the Jacobian with respect to the base coordinate frame of the LBR4pSimple copy arm. 
...
/*!\fn void LBR4pSimple_jacob0(double J0[][6], const double* input1);
\param input1:  7-element vector of generalized coordinates.
\param J0:  [6x7] Jacobian matrix
*/
...
void LBR4pSimple_jacob0(double J0[][6], const double* input1);
