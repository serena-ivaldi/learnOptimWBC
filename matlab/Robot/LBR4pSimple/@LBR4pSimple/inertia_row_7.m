...
%    inertia matrix row number 7 of 7 for LBR4pSimple copy. 
%    
%  Input:: 
...
t7 = sin(q3);
t8 = t4.*t6.*(3.0./5.0e1);
t9 = t2.*t3.*t5.*(3.0./5.0e1);
t10 = t8+t9;
t11 = cos(q3);
t12 = sin(q5);
t13 = t3.*t4.*(3.0./5.0e1);
t14 = t13-t2.*t5.*t6.*(3.0./5.0e1);
Irow = [-sin(q2).*(t10.*t11-t2.*t7.*t12.*(3.0./5.0e1))+t14.*cos(q2),t7.*t10+t2.*t11.*t12.*(3.0./5.0e1),t14,t2.*t12.*(3.0./5.0e1),t4.*(3.0./5.0e1),0.0,3.0./5.0e1];
