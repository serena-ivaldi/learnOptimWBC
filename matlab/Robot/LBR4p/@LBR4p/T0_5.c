/* LBR4P_T0_5 - This file contains auto generated C-code for a MATLAB MEX function.
// For details on how to use the complied MEX function see the documentation provided in LBR4p_T0_5.m
        ...
        int nrhs, const mxArray *prhs[])
{
	...
	if(nrhs!=2) {
		mexErrMsgIdAndTxt("LBR4p_T0_5:nrhs",
		                       "1 inputs required.");
	}
	if(nlhs>1) {
		mexErrMsgIdAndTxt("LBR4p_T0_5:nlhs",
