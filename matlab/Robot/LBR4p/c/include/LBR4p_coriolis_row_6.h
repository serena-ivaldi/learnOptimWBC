...
Coriolis matrix row number 6 of 7 for LBR4p copy. Angles have to be given in radians! 
...
/*!\fn void LBR4p_coriolis_row_6(double C_row_6[][1], const double* input1, const double* input2);
...
#ifndef LBR4P_CORIOLIS_ROW_6_H
#define LBR4P_CORIOLIS_ROW_6_H

#include "math.h"

void LBR4p_coriolis_row_6(double C_row_6[][1], const double* input1, const double* input2);

#endif /*LBR4P_CORIOLIS_ROW_6_H */
