/*! \file LBR4p_jacob0.h
\brief C code for the Jacobian with respect to the base coordinate frame of the LBR4p copy arm. 
...
/*!\fn void LBR4p_jacob0(double J0[][6], const double* input1);
...
void LBR4p_jacob0(double J0[][6], const double* input1);
