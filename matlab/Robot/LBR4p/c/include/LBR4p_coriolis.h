/*! \file LBR4p_coriolis.h
\brief Coriolis matrix for the LBR4p copy arm. 
...
/*!\fn void LBR4p_coriolis(double C[][7], const double* input1, const double* input2)
...
#ifndef LBR4P_CORIOLIS_H
#define LBR4P_CORIOLIS_H
