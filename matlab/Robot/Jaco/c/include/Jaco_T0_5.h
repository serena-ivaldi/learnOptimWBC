/*! \file Jaco_T0_5.h
\brief C version of the forward kinematics for the Jaco copy arm up to frame 5 of 6. 
...
/*!\fn void Jaco_T0_5(double T[][4], const double* input1);
...
void Jaco_T0_5(double T[][4], const double* input1);
