/*! \file Jaco_T0_6.h
\brief C version of the forward kinematics for the Jaco copy arm up to frame 6 of 6. 
...
/*!\fn void Jaco_T0_6(double T[][4], const double* input1);
...
void Jaco_T0_6(double T[][4], const double* input1);
