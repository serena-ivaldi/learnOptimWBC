...
function [tau, mean_performances, bestAction, BestActionPerEachGen, policies, costs, succeeded, name_dat] = OptimizationRoutine_iCub(number_of_iteration,n_of_experiment,iter,init_parameters_from_out)  
    ...
    [bot1, name_scenario, time_struct, time_sym_struct, reference, alphas, controller, constr, inst, generation_of_starting_point, ...
