...
% This configuration is the same as configuration #3, but uses the WBM-Toolbox instead.
...
wbm_icub    = initRobotICub_32dof(wf2fixlnk);
...
bot1.sim_config = initSimConfigICub_32dof(icub_model.urdf_robot_name, 'DarkScn');
