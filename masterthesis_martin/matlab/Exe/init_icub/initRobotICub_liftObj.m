function [icub_model, icub_config, ndof] = initRobotICub_liftObj()
    %% Initializes the model and configuration parameters for the iCub robot with
    %  an arms and torso free configuration:
    %
    ...
    icub_config.jpos_left_arm  = [0; 0; 0; 70; 0; 0; 0];
