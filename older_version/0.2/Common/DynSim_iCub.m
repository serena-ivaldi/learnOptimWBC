...
if param.active_floating_base == true %% TODO for now it's just to avoid to modify it directly iin iCub.m
...
%% TODO we have to put it back
%tau = controller.Policy(t,qj,dqj,fc,Jc_t); 
%% TODO just for fixing the balance
...
dqt_b   = dquat(qt_b,omega_b);   %% TODO floating base flag required (parameter of the simulator)
dx      = [dx_b;dqt_b;dqj];
