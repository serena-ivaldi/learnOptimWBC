...
%    inertia matrix row number 6 of 6 for Puma 560 copy. 
%    
%  Input:: 
...
t7 = sin(q4);
t8 = t6.*t7.*4.0e-5;
Irow = [cos(q2).*(t2.*t4.*4.0e-5-t3.*t5.*t6.*4.0e-5)-sin(q2).*(t2.*t3.*4.0e-5+t4.*t5.*t6.*4.0e-5),t8,t8,t2.*4.0e-5,0.0,1.94104505668e-1];
