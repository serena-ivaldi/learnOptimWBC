/*! \file Puma560_jacob0.h
\brief C code for the Jacobian with respect to the base coordinate frame of the Puma 560 copy arm. 
...
/*!\fn void Puma560_jacob0(double J0[][6], const double* input1);
