...
%% T0_3 - Forward kinematics for the LBR4pSimple copy arm up to frame 3 of 7. 
% ========================================================================= 
%    
%    T = T0_3(rob,q) 
%    T = rob.T0_3(q) 
...
%    
%  Output:: 
%    T:  [4x4] Homogenous transformation matrix relating the pose of joint 3 of 7 
...
t6 = sin(q3);
t7 = sin(q2);
T0_3 = reshape([-t4.*t6+t2.*t3.*t5,t2.*t6+t3.*t4.*t5,-t3.*t7,0.0,-t2.*t7,-t4.*t7,-t5,0.0,-t3.*t4-t2.*t5.*t6,t2.*t3-t4.*t5.*t6,t6.*t7,0.0,t2.*t7.*(2.0./5.0),t4.*t7.*(2.0./5.0),t5.*(2.0./5.0)+3.1e1./1.0e2,1.0],[4, 4]);
