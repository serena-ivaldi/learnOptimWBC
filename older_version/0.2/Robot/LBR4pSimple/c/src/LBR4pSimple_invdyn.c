#include "LBR4pSimple_invdyn.h"

void LBR4pSimple_invdyn(double TAU[][7], const double* input1, const double* input2, const double* input3){
...
/* rowwise routines */
LBR4pSimple_inertia_row_1(inertia_row1, input1);
LBR4pSimple_inertia_row_2(inertia_row2, input1);
LBR4pSimple_inertia_row_3(inertia_row3, input1);
LBR4pSimple_inertia_row_4(inertia_row4, input1);
LBR4pSimple_inertia_row_5(inertia_row5, input1);
LBR4pSimple_inertia_row_6(inertia_row6, input1);
LBR4pSimple_inertia_row_7(inertia_row7, input1);
LBR4pSimple_coriolis_row_1(coriolis_row1, input1, input2);
LBR4pSimple_coriolis_row_2(coriolis_row2, input1, input2);
LBR4pSimple_coriolis_row_3(coriolis_row3, input1, input2);
LBR4pSimple_coriolis_row_4(coriolis_row4, input1, input2);
LBR4pSimple_coriolis_row_5(coriolis_row5, input1, input2);
LBR4pSimple_coriolis_row_6(coriolis_row6, input1, input2);
LBR4pSimple_coriolis_row_7(coriolis_row7, input1, input2);
