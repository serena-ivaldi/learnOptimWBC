/*! \file LBR4pSimple_invdyn.h
\brief C-implementation of the inverse dynamics for the LBR4pSimple copy arm. 
...
/*!\fn void LBR4pSimple_invdyn(double TAU[][7], const double* input1, const double* input2, const double* input3);
...
#ifndef LBR4PSIMPLE_INVDYN_H
#define LBR4PSIMPLE_INVDYN_H
