/*! \file LBR4pReal_T0_3.h
\brief C version of the forward kinematics for the LBR4pReal copy arm up to frame 3 of 7. 
...
/*!\fn void LBR4pReal_T0_3(double T[][4], const double* input1);
...
#ifndef LBR4PREAL_T0_3_H
#define LBR4PREAL_T0_3_H

#include "math.h"

void LBR4pReal_T0_3(double T[][4], const double* input1);

#endif /*LBR4PREAL_T0_3_H */
