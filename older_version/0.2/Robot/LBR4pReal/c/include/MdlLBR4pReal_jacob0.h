/*! \file MdlLBR4pReal_jacob0.h
\brief C code for the Jacobian with respect to the base coordinate frame of the MdlLBR4pReal copy arm. 
...
/*!\fn void MdlLBR4pReal_jacob0(double J0[][6], const double* input1);
...
void MdlLBR4pReal_jacob0(double J0[][6], const double* input1);
