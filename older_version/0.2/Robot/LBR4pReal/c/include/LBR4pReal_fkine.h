/*! \file fkine.h
\brief C version of the forward kinematics solution including tool transformation for the LBR4pReal copy arm. 
...
/*!\fn void LBR4pReal_fkine(double T[][4], const double* input1);
...
#ifndef LBR4PREAL_FKINE_H
#define LBR4PREAL_FKINE_H

#include "math.h"

void LBR4pReal_fkine(double T[][4], const double* input1);

#endif /*LBR4PREAL_FKINE_H */
