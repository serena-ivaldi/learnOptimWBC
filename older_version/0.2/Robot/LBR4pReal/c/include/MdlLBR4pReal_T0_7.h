/*! \file MdlLBR4pReal_T0_7.h
\brief C version of the forward kinematics for the MdlLBR4pReal copy arm up to frame 7 of 7. 
...
/*!\fn void MdlLBR4pReal_T0_7(double T[][4], const double* input1);
...
#ifndef MDLLBR4PREAL_T0_7_H
#define MDLLBR4PREAL_T0_7_H

#include "math.h"

void MdlLBR4pReal_T0_7(double T[][4], const double* input1);

#endif /*MDLLBR4PREAL_T0_7_H */
