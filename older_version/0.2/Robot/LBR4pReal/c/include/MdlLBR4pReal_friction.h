/*! \file MdlLBR4pReal_friction.h
\brief Joint friction for the MdlLBR4pReal copy arm. 
...
/*!\fn void MdlLBR4pReal_friction(double F[][1], const double* input1);
\param input1:  7-element vector of generalized velocities.
\param F:  [7x1] output vector of joint friction forces/torques.
*/


#ifndef MDLLBR4PREAL_FRICTION_H
#define MDLLBR4PREAL_FRICTION_H

#include "math.h"

void MdlLBR4pReal_friction(double F[][1], const double* input1);

#endif /*MDLLBR4PREAL_FRICTION_H */
