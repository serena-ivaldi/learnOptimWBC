/*! \file fkine.h
\brief C version of the forward kinematics solution including tool transformation for the MdlLBR4pReal copy arm. 
...
/*!\fn void MdlLBR4pReal_fkine(double T[][4], const double* input1);
...
#ifndef MDLLBR4PREAL_FKINE_H
#define MDLLBR4PREAL_FKINE_H

#include "math.h"

void MdlLBR4pReal_fkine(double T[][4], const double* input1);

#endif /*MDLLBR4PREAL_FKINE_H */
