/*! \file MdlLBR4pReal_gravload.h
\brief Computation of the configuration dependent vector of gravitational load forces/torques for MdlLBR4pReal copy 
...
/*!\fn void MdlLBR4pReal_gravload(double G[][1], const double* input1);
\param input1: 7-element vector of generalized coordinates.
\param G: [7x1] output vector of gravitational load forces/torques.
*/


#ifndef MDLLBR4PREAL_GRAVLOAD_H
#define MDLLBR4PREAL_GRAVLOAD_H

#include "math.h"

void MdlLBR4pReal_gravload(double G[][1], const double* input1);

#endif /*MDLLBR4PREAL_GRAVLOAD_H */
