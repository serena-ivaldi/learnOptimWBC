/*! \file LBR4pReal_coriolis.h
\brief Coriolis matrix for the LBR4pReal copy arm. 
...
/*!\fn void LBR4pReal_coriolis(double C[][7], const double* input1, const double* input2)
...
#ifndef LBR4PREAL_CORIOLIS_H
#define LBR4PREAL_CORIOLIS_H
