/*! \file LBR4pReal_accel.h
\brief C-implementation of the forward dynamics for the LBR4pReal copy arm. 
...
/*!\fn void LBR4pReal_accel(double QDD[][7], const double* input1, const double* input2, const double* input3);
...
#ifndef LBR4PREAL_ACCEL_H
#define LBR4PREAL_ACCEL_H
