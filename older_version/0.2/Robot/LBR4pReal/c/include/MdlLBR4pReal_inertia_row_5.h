/*! \file MdlLBR4pReal_inertia_row_5.h
...
inertia matrix row number 5 of 7 for MdlLBR4pReal copy. Angles have to be given in radians! 
...
/*!\fn void MdlLBR4pReal_inertia_row_5(double I_row_5[][1], const double* input1);
\param input1:  7-element vector of generalized coordinates.
\param I_row_5:  [1x7] output row of the robot inertia matrix.
*/


#ifndef MDLLBR4PREAL_INERTIA_ROW_5_H
#define MDLLBR4PREAL_INERTIA_ROW_5_H

#include "math.h"

void MdlLBR4pReal_inertia_row_5(double I_row_5[][1], const double* input1);

#endif /*MDLLBR4PREAL_INERTIA_ROW_5_H */
