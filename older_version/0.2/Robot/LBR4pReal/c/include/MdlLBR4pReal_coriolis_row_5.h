/*! \file MdlLBR4pReal_coriolis_row_5.h
...
Coriolis matrix row number 5 of 7 for MdlLBR4pReal copy. Angles have to be given in radians! 
...
/*!\fn void MdlLBR4pReal_coriolis_row_5(double C_row_5[][1], const double* input1, const double* input2);
...
#ifndef MDLLBR4PREAL_CORIOLIS_ROW_5_H
#define MDLLBR4PREAL_CORIOLIS_ROW_5_H

#include "math.h"

void MdlLBR4pReal_coriolis_row_5(double C_row_5[][1], const double* input1, const double* input2);

#endif /*MDLLBR4PREAL_CORIOLIS_ROW_5_H */
