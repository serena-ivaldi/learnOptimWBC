/*! \file LBR4pReal_inertia_row_1.h
...
inertia matrix row number 1 of 7 for LBR4pReal copy. Angles have to be given in radians! 
...
/*!\fn void LBR4pReal_inertia_row_1(double I_row_1[][1], const double* input1);
\param input1:  7-element vector of generalized coordinates.
\param I_row_1:  [1x7] output row of the robot inertia matrix.
*/


#ifndef LBR4PREAL_INERTIA_ROW_1_H
#define LBR4PREAL_INERTIA_ROW_1_H

#include "math.h"

void LBR4pReal_inertia_row_1(double I_row_1[][1], const double* input1);

#endif /*LBR4PREAL_INERTIA_ROW_1_H */
