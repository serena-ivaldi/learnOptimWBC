/*! \file LBR4pReal_coriolis_row_5.h
...
Coriolis matrix row number 5 of 7 for LBR4pReal copy. Angles have to be given in radians! 
...
/*!\fn void LBR4pReal_coriolis_row_5(double C_row_5[][1], const double* input1, const double* input2);
...
#ifndef LBR4PREAL_CORIOLIS_ROW_5_H
#define LBR4PREAL_CORIOLIS_ROW_5_H

#include "math.h"

void LBR4pReal_coriolis_row_5(double C_row_5[][1], const double* input1, const double* input2);

#endif /*LBR4PREAL_CORIOLIS_ROW_5_H */
