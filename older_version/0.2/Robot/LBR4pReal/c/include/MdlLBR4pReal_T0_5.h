/*! \file MdlLBR4pReal_T0_5.h
\brief C version of the forward kinematics for the MdlLBR4pReal copy arm up to frame 5 of 7. 
...
/*!\fn void MdlLBR4pReal_T0_5(double T[][4], const double* input1);
...
#ifndef MDLLBR4PREAL_T0_5_H
#define MDLLBR4PREAL_T0_5_H

#include "math.h"

void MdlLBR4pReal_T0_5(double T[][4], const double* input1);

#endif /*MDLLBR4PREAL_T0_5_H */
