/*! \file MdlLBR4pReal_coriolis_row_2.h
...
Coriolis matrix row number 2 of 7 for MdlLBR4pReal copy. Angles have to be given in radians! 
...
/*!\fn void MdlLBR4pReal_coriolis_row_2(double C_row_2[][1], const double* input1, const double* input2);
...
#ifndef MDLLBR4PREAL_CORIOLIS_ROW_2_H
#define MDLLBR4PREAL_CORIOLIS_ROW_2_H

#include "math.h"

void MdlLBR4pReal_coriolis_row_2(double C_row_2[][1], const double* input1, const double* input2);

#endif /*MDLLBR4PREAL_CORIOLIS_ROW_2_H */
