...
void LBR4pReal_inertia_row_5(double I_row_5[][1], const double* input1){
 ...
 I_row_5[6][0]=0;
  ...
  I_row_5[4][0] = cos(q6*2.0)*(-2.7754728370115E-3)+sin(q6*2.0)*2.323533766E-6+1.13496289368925E-2;
