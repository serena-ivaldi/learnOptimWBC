#include "LBR4pReal_accel.h"

void LBR4pReal_accel(double QDD[][7], const double* input1, const double* input2, const double* input3){
	...
	LBR4pReal_inertia(inertia, input1);
	gaussjordan(inertia, invinertia, 7);
	LBR4pReal_coriolis(coriolis, input1, input2);
