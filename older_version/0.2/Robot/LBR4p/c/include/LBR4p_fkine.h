/*! \file fkine.h
\brief C version of the forward kinematics solution including tool transformation for the LBR4p copy arm. 
...
/*!\fn void LBR4p_fkine(double T[][4], const double* input1);
...
#ifndef LBR4P_FKINE_H
#define LBR4P_FKINE_H
