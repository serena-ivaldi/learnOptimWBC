...
%parameters first chains
geom_parameters{1,1} = [0,-0.74,0.70]; 
geom_parameters{1,2} = [-0.18 -0.35 0.48]; geom_parameters{1,3} = [120 116 90 0 0 0]* deg;
...
geom_parameters_sec{1,2} = [-0.309 -0.469 0.581]; geom_parameters_sec{1,3} = [120 116 90 0 0 0]* deg; 
