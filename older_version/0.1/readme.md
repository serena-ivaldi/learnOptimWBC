...
General Comments
--------------
- We choose the parameters of the RBF functions to have a good coverage of the time span of the experiments
- An expert perform the design of the manually tuned activation parameters 
- The exploration rates adopted during the experiment are standard values for this kind of parameters
- The number of generations is choosed in order to obtain the converge of learning procedure (CMA-ES)
