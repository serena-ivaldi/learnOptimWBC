/*! \file Puma560_coriolis.h
\brief Coriolis matrix for the Puma 560 copy arm. 
...
/*!\fn void Puma560_coriolis(double C[][6], const double* input1, const double* input2)
\param input1:  6-element vector of generalized coordinates
\param input2: 6-element vector of generalized velocities
\param C:  [6x6] Coriolis matrix
*/


#ifndef PUMA560_CORIOLIS_H
#define PUMA560_CORIOLIS_H
