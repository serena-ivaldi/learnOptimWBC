...
void Puma560_T0_6(double T[][4], const double* input1){
 ...
 T[3][3]=0;
  ...
  T[0][2] = cos(q6)*(sin(q5)*(cos(q2)*cos(q3)-sin(q2)*sin(q3))+cos(q4)*cos(q5)*(cos(q2)*sin(q3)+cos(q3)*sin(q2)))-sin(q4)*sin(q6)*(cos(q2)*sin(q3)+cos(q3)*sin(q2));
  ...
  T[1][2] = -sin(q6)*(sin(q5)*(cos(q2)*cos(q3)-sin(q2)*sin(q3))+cos(q4)*cos(q5)*(cos(q2)*sin(q3)+cos(q3)*sin(q2)))-cos(q6)*sin(q4)*(cos(q2)*sin(q3)+cos(q3)*sin(q2));
