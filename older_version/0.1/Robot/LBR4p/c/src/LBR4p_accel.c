...
void LBR4p_accel(double QDD[][7], const double* input1, const double* input2, const double* input3){
	...
	LBR4p_inertia(inertia, input1);
	gaussjordan(inertia, invinertia, 7);
	LBR4p_coriolis(coriolis, input1, input2);
