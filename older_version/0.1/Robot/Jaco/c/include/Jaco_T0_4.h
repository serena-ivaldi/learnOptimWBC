/*! \file Jaco_T0_4.h
\brief C version of the forward kinematics for the Jaco copy arm up to frame 4 of 6. 
...
/*!\fn void Jaco_T0_4(double T[][4], const double* input1);
...
void Jaco_T0_4(double T[][4], const double* input1);
