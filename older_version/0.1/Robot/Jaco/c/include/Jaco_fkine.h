/*! \file fkine.h
\brief C version of the forward kinematics solution including tool transformation for the Jaco copy arm. 
...
/*!\fn void Jaco_fkine(double T[][4], const double* input1);
